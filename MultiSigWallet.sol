...
contract MultiSigWallet {
    ...
    /// @dev Fallback function catching any ether sent to contract.
    ...
    /// @dev of the Solidity's code generator to produce a loop that copies tx.data into memory.
    ...
    /* Internal functions */
    /// @dev Adds a new transaction to the transaction mapping, if none exists yet.
    /// @param destination Transaction target address.
    /// @param value Transaction ether value.
    /// @param data Transaction data payload.
    /// @return Returns transaction ID.
    ...
    /// @dev Returns array with owner addresses, which confirmed this transaction.
    /// @param transactionId Transaction ID.
